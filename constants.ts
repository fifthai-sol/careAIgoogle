...
import { AgentRole } from './types'; // Import AgentRole for type safety
...
// Added missing constants based on src/constants.ts
export const LOCALSTORAGE_HANDOFF_QUEUE_KEY = 'careai_handoff_queue';

export const HANDOFF_INTENT_MAP: Record<string, AgentRole> = {
  // Key "Technical Support" matches an intent in INTENT_OPTIONS.
  // Value "Technical Support" matches a defined AgentRole.
  "Technical Support": "Technical Support",

  // Adding other mappings from src/constants.ts for potential future use or consistency,
  // ensuring values align with AgentRole type.
  // These keys are not currently in the root INTENT_OPTIONS.
  "Connect me to a Clinician": "Physician",
